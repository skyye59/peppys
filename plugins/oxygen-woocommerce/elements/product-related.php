...
class ProductRelated extends \OxyWooEl {
    ...
    function render($options, $defaults, $content) {
		...
		$title = apply_filters( 'woocommerce_product_related_products_heading', __( 'Related products' ) );
	    ...
	    remove_filter('woocommerce_product_related_products_heading', '__return_false');
    ...
    function controls() {
        ...
        /* Products Title */
        $products_title = $this->typographySection(
            __("Products Title"),
            "h1.woocommerce-loop-product__title,h2.woocommerce-loop-product__title,h3.woocommerce-loop-product__title,h4.woocommerce-loop-product__title,h5.woocommerce-loop-product__title,h6.woocommerce-loop-product__title",
            $this
        );

        $products_title->addOptionControl(
            array(
                "type" => "dropdown",
